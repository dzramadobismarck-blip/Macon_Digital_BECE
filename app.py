...
# --- PAGE CONFIGURATION ---
st.set_page_config(
    page_title="Artificial Intelligence Assignment | Group Two",
    page_icon="🎓",
    layout="wide"
)
...
if not st.session_state.search_fulfilled:
    ...
    if st.session_state.df is not None:
        ...
        st.error("Error: 'bece_questions_randomized.csv' not found. Please ensure the file is in the project directory.")